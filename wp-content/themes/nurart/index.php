...
<meta charset="utf-8" />
    <link rel="shortcut icon" href="/wp-content/themes/nurart/favicon.ico" />
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /wp-content/themes/nurart in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/wp-content/themes/nurart) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/wp-content/themes/nurart/favicon.ico" will
        work correctly both with client-side routing and a non-root public URL.
        Learn how to configure a non-root public URL by running `npm run wpbuild`.
    -->
    <title>React WordPress Theme</title>
<link href="/wp-content/themes/nurart/static/css/main.chunk.css?db26f5f0c465741ba977" rel="stylesheet"></head>
    <body>
    <noscript>
    ...
    -->
    <script src="/wp-content/themes/nurart/static/js/bundle.js?db26f5f0c465741ba977"></script><script src="/wp-content/themes/nurart/static/js/0.chunk.js?db26f5f0c465741ba977"></script><script src="/wp-content/themes/nurart/static/js/main.chunk.js?db26f5f0c465741ba977"></script></body>
</html>
