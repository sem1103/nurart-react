...
export default function SimpleProd(props) {
    ...
    // onClick={() => addFavoriteItem({...props, prodType: true, favorite: true})}
    return (
        <div className={`${s.cart} ${s.simpleProd}`}>
            <button className={s.favorite__add} onClick={() => removeFavoriteItem({...props, prodType: true, favorite: false})}>
