...
export default function ComplexDefault({productName, boxImg, haveBox, paintItem, stambSize, img, paintItem , descAZ, descRu, changePillowsAz, changePillowsRu, exampleStamb}){
    return(
