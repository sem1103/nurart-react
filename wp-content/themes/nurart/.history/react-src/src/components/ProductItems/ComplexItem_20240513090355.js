...
export default function ComplexItem(props) {
    ...
    const showMore = (props.ind) => {
        pElements.current[props.ind].classList.toggle(s.show__more)
    }
    ...
    return (
        <div key={props.productName} className={s.cart}>
            ...
            <div className={s.cart__name}>
                <props.img src={props.boxprops.img} className={s.have__box} alt="hav box" style={{ visibility: props.haveBox ? 'initial' : 'hidden' }} />
            ...
            <div className={s.product}>
                <props.img src={props.img} alt="" className={s.prod__props.img} />
                <div className={`${s.prod__desc} ${props.paintItem ? s.paint__desc : ''}`}>
                    ...
                    <props.img src={props.exampleStamb} alt="" className={s.example} />
                </div>
            </div>
