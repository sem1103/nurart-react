...
export default function SimpleProd({img, productAz ,productRu}) {
    ...
    return (
        <div className={s.cart}>
            ...
            <img src={img} alt="" className={s.cart__img} />
            <div className={s.cart__desc}>
                <h3>{i18next.language == 'az' ? productAz.productName : productRu.productName}</h3>
                <div dangerouslySetInnerHTML={{ __html: i18next.language == 'az' ? productAz.desc : productRu.desc }} />
