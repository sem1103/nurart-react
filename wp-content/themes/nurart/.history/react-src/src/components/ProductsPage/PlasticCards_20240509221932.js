...
import usePolygrafySlice from '../../store/dataSlice'
...
export default function PlasticCards() {
    ...
    useEffect(() => {
        resetItems();
        !allItems.plastic.length && fetchData('http://localhost/wp-json/wp/v2/plastic_cards/', 'http://localhost/wp-json/wp/v2/media/');        
    }, []);
