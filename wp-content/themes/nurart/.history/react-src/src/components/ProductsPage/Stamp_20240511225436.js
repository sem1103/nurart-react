                        ...
                        loader ? <h3>Loading...</h3>
                            ...
                            items.shtamp.map((item, ind) => {
                                return <div key={item.productName} className={s.cart}>
                                  ...
                                  <svg width={30} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><g id="Layer_63" data-name="Layer 63"><path d="m29.29 48.34 18.01 12.11h.61v-53.02h-34.95v53.02h1.64z" fill="rgb(87, 87, 87)" ></path><g fill="#006df0"><path d="m45.91 20.5a2 2 0 0 0 -2 2v33.67l-13.48-9.4a2 2 0 0 0 -2.29 0l-13.48 9.4v-44.74h18.19a2 2 0 0 0 0-4h-20.19a2 2 0 0 0 -2 2v50.57a2 2 0 0 0 3.14 1.64l15.49-10.79 15.48 10.79a2 2 0 0 0 1.14.36 2 2 0 0 0 .93-.23 2 2 0 0 0 1.07-1.77v-37.5a2 2 0 0 0 -2-2z" fill="rgb(48, 48, 48)" ></path><path d="m51.34 7.43h-3.43v-3.43a2 2 0 0 0 -4 0v3.43h-3.43a2 2 0 0 0 0 4h3.43v3.43a2 2 0 0 0 4 0v-3.43h3.43a2 2 0 0 0 0-4z" fill="rgb(48, 48, 48)" ></path></g></g></svg>
                                </button>
