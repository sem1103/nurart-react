...
export default function Stamp() {
    ...
    useEffect(()=>{
        // pElements.current = pElements.current.slice(0, allItems.shtamp.length);
                                   ...
                                   <button className={s.favorite__add}>
                                    ...
                                    <div className={s.product}>
                                        ...
                                        <div className={`${s.prod__desc} ${item.paintItem ? s.paint__desc : ''}`}>
                                            {
                                                item.paintItem ? 
                                                <div ref={el => item.paintItem ? pElements.current[ind] = el : ''} dangerouslySetInnerHTML={{__html: i18next.language == 'az' ? item.descAZ : item.descRu}} />
                                                :
                                                <div>
