...
export default function Polygraphy() {
    ...
    const filterCategory = (category) => {
        filterByCategory(category, 'polygraphy');
    }
    ...
    return (
        ...
        <>
            ...
            <div className={`container ${s.products__page}`}>
                ...
                <FilterCategory filterCategories={filters.polygraphy} filterByCategory={filterByCategory} filterByName={searchByName} placeholder='Məhsulun adı ilə axtarış...' />
