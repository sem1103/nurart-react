...
export default function Polygraphy() {
    ...
    const {items, allItems, filters, fetchData, filterByName, resetItems} = useDataSlice();
    ...
    return (
        ...
        <>
            ...
            <div className={`container ${s.products__page}`}>
                ...
                <FilterCategory filterCategory={filters.polygraphy} func={searchByName} placeholder='Məhsulun adı ilə axtarış...' />
