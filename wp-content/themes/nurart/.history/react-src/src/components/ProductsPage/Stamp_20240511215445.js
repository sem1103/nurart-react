...
export default function Stamp() {
    ...
    const setMaxHeight = (elem) => {
        elem.style.maxHeigth = elem.clientHeight + 'px'
    }
                                   ...
                                   <button className={s.favorite__add}>
                                    ...
                                    <div className={s.product}>
                                        ...
                                        <div className={`${s.prod__desc} ${item.paintItem ? s.paint__desc : ''}`}>
                                            {
                                                item.paintItem ? 
                                                <div onClick={(e) => setMaxHeight(e.target)} dangerouslySetInnerHTML={{__html: i18next.language == 'az' ? item.descAZ : item.descRu}} />
                                                :
                                                <div>
