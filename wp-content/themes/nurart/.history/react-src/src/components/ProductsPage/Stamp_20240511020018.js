...
export default function Stamp() {
    ...
    const searchByName =  useDebounce(value => {
        ...
        const filterCategory = (category) => {
            filterByCategory(category, 'shtamp');
        }
    ...
    return (
        ...
        <>
            ...
            <div className={`container ${s.products__page}`}>
                ...
                <FilterCategory filterCategory={filterCategory} filterByCategory={filterCategory} filterByName={searchByName} placeholder='Məhsulun kodu ilə axtarış...' />
