                    ...
                    state => ({
                        items: {
                            ...
                            [type]: state.allItems[type].filter(item => {
                                ...
                                return i18next.language == 'az' ? normalizeAzerbaijani(item.productAz.productName).includes(value.toLowerCase()) && state.activeCategory == item.categories.value : item.productRu.productName.toLowerCase().includes(value.toLowerCase() && state.activeCategory == item.categories.value);
                            })
                        }
                    })
                )
