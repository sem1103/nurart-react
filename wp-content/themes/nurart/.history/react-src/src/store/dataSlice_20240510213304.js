                    ...
                    state => ({
                        items: {
                            ...
                            [type]: state.allItems[type].filter(item => {
                                ...
                                (normalizeAzerbaijani(item.productAz.productName).includes(value.toLowerCase()) && state.activeCategory && state.activeCategory == item.categories.value) 
                                : 
                                (item.productRu.productName.toLowerCase().includes(value.toLowerCase()) && state.activeCategory && state.activeCategory == item.categories.value);
                            })
                        }
                    })
                )
