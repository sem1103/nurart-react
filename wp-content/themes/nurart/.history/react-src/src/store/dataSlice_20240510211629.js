                    ...
                    state => ({
                        items : {
                            ...
                            [type]: state.allItems[type].filter( item => {
                                if(category == 'all') return state.allItems[type];
            ...
            filterByName : (value, type) => {
                ...
                set(
                    state => ({
                        items: {
                            ...state.items,
                            [type]: state[activeItems][type].filter(item => {
                ...
                activeItems = get().items[type].length !== get().allItems[type].length ? 'allItems' : 'items';
            },
            filterByCode : value => {
                set(
                    state => ({
