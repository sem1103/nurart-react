                        ...
                        items: {
                            ...
                            [type]: state.allItems[type].filter(item => {
                                ...
                                if(state.activeCategory){
                                    if(i18next.language == 'az') return normalizeAzerbaijani(item.productAz.productName).includes(value.toLowerCase());
                                    else return item.productRu.productName.toLowerCase().includes(value.toLowerCase())
                                }
                            })
                        }
                    })
