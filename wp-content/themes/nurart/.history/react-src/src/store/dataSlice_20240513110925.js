    ...
    devtools(
        (set,get) => ({
            ...
            addFavoriteItem: (item) =>{
                ...
                set(state => ({favoriteItems: state.favoriteItems.push(item)}));
            ...
            getFavoriteItems: () => {
                set(state => ({favoriteItems:  JSON.parse(localStorage.getItem('favorites')) ? JSON.parse(localStorage.getItem('favorites')) : []}))
            }
        })
    )
)
